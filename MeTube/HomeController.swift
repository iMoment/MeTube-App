...
class HomeController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    func setupNavBarButtons() {
        ...
        let navigationMoreImage = UIImage(named: "navigationMore")?.withRenderingMode(.alwaysOriginal)
...
//        print(targetContentOffset.memory.x)
        ...
        menuBar.menuBarCollectionView.selectItem(at: indexPath, animated: true, scrollPosition: UICollectionViewScrollPosition())
